...
public class ExtractionRestBindingStub extends ExtractionService
{
    ...
    @Override 
    public com.j9.services.strong.tcjira_extraction._2022_06.Extraction.Output extractionOperation( com.j9.services.strong.tcjira_extraction._2022_06.Extraction.Input operationInput ) 
    
    {
       try
       {
        restSender.pushRequestId();
        com.teamcenter.soa.internal.common.Monitor.markStart("com.j9.services.strong.tcjira_extraction.ExtractionRestBindingStub.extractionOperation");
        ...
        Object outObj = restSender.invoke3( EXTRACTION_202206_PORT_NAME, "extractionOperation", sourceArgs, 
                        com.j9.services.strong.tcjira_extraction._2022_06.Extraction.class);
		


        com.j9.services.strong.tcjira_extraction._2022_06.Extraction.Output localOut = (com.j9.services.strong.tcjira_extraction._2022_06.Extraction.Output) outObj;
        ...
        com.teamcenter.soa.internal.common.Monitor.markEnd  ("com.j9.services.strong.tcjira_extraction.ExtractionRestBindingStub.extractionOperation");
         return localOut;
       }
       finally
       {
