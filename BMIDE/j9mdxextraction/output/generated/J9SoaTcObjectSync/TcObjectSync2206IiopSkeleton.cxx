...
namespace J9
{
        ...
        IiopSkeleton()
    {
       ...
       _svcMap[ "tcObjectSyncOperation" ]   = tcObjectSyncOperation;
		...
		_service = new J9::Soa::TcObjectSync::_2022_06::TcObjectSyncImpl();
    ...
    {
        ScopedJournal _journalSkeleton( "J9::Soa::TcObjectSync::_2022_06::TcObjectSync::TcObjectSyncIiopSkeleton::tcObjectSyncOperation" );

        std::string _contentType;
        J9::Soa::TcObjectSync::_2022_06::TcObjectSync::INPUTMAP  inputMap;
        J9::Soa::TcObjectSync::_2022_06::TcObjectSync::OUTPUT _out;

        //  ========== Parse the input XML or JSON document to the local input arguments ==========
        {
            ScopedJournal _journalParse( "J9::Soa::TcObjectSync::_2022_06::TcObjectSyncIiopSkeleton::tcObjectSyncOperation - Parse input document" );
            Teamcenter::Soa::Internal::Server::SdmParser _sdmParser( xmlOrJsonDoc );
            _contentType = _sdmParser.getDocumentType();
            _sdmParser.parseStructMember( "inputMap", inputMap );
        }        


        //  ===================== Call the service operation implementation  ======================
        {
            ScopedJournal journalExecute( "J9::Soa::TcObjectSync::_2022_06::TcObjectSyncImpl::tcObjectSyncOperation" );
            ScopedMemoryChangeLogger memoryLogger( "J9::Soa::TcObjectSync::_2022_06::TcObjectSyncImpl::tcObjectSyncOperation" );
            _out = _service->tcObjectSyncOperation( inputMap );
        }

        //  ================== Serialize the response to a XML or JSON document  ==================
        {
            ScopedJournal _journalSerialize(  "J9::Soa::TcObjectSync::_2022_06::TcObjectSyncIiopSkeleton::tcObjectSyncOperation - Serialize output document" );
...
J9::Soa::TcObjectSync::_2022_06::TcObjectSyncImpl* TcObjectSyncIiopSkeleton::_service = NULL;
...
extern
#endif
void TcObjectSync_2022_06_TcObjectSync_ConstructT2LService( Teamcenter::Soa::Internal::Gateway::T2LService **service )
{
