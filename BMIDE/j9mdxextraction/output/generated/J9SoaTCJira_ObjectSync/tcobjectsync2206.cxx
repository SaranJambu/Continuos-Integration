...
const std::string TcObjectSync::XSD_NAMESPACE ="http://j9.com/Schemas/TCJira_ObjectSync/2022-06/TcObjectSync";
...
void TcObjectSync::OUTPUT::serialize( Teamcenter::Soa::Internal::Server::SdmStream* _sdmStream, const std::string& elementName )
{
    ...
    _sdmStream->writeOpenElement2( J9::Soa::TCJira_ObjectSync::_2022_06::TcObjectSync::XSD_NAMESPACE, elementName );
    _sdmStream->writeStructMember( "outputValue", outputValue );
    _sdmStream->writeOpenElementClose(  J9::Soa::TCJira_ObjectSync::_2022_06::TcObjectSync::XSD_NAMESPACE, true );
